...
def main():#query="is:unread", tag="daily_report", count=3):
    ...
    # target_label_ids = [label["id"] for label in labels] #ラベルの取得
...
if __name__ == "__main__":
    # arguments = docopt(__doc__, version="0.1") #引数をとってくる
    # query = arguments["<query>"]
    # subject = arguments["<subject>"]
    # count = arguments["<count>"]
    #logging.basicConfig(level=logging.DEBUG)

    messages_ = main()#query=query, subject=subject, count=count)